...
UartDevice& MicroNMEA::sendSentence(UartDevice& s, const char* sentence)
{
  char checksum[3];
...
bool MicroNMEA::processGGA(const char *s)
{
  ...
  // to indicate GPS regardless of actual altitude system used.
...
bool MicroNMEA::processRMC(const char* s)
{
  ...
  // ID to indicate GPS regardless of actual altitude system used.
  _navSystem = _talkerID;
