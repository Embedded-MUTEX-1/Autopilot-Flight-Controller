...
int8_t EspNow::init() {
    ...
    ret = esp_now_init();
    ret = esp_wifi_config_espnow_rate(WIFI_IF_STA, WIFI_PHY_RATE_1M_L);
    ret = esp_now_register_send_cb(&EspNow::OnDataSent);
    ret = esp_now_register_recv_cb(&EspNow::OnDataRecv);
