...
#define twoKiDef	(2.0f * 0.0025f)	// 2 * integral gain
...
void Mahony::setConfig(float twoKp, float twoKi) {
    this->twoKp = twoKp;	// 2 * proportional gain (Kp)
	this->twoKi = twoKi;	// 2 * integral gain (Ki)
}
