...
class QuickPID {
  ...
  public:
    ...
    QuickPID(float Kp, float Ki, float Kd,
    ...
    QuickPID(float Kp, float Ki, float Kd, Action Action);
    ...
    float Compute(float sp, float fb);
    ...
    void SetTunings_(float Kp, float Ki, float Kd, pMode pMode, dMode dMode, iAwMode iAwMode);
    ...
    void getConfig(float &kp, float &ki, float &kd);
